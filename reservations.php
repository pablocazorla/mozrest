      ...
      <div class="relative pt-lg-0 pt-5" data-aos="fade">
        <div class="pt-lg-0 pt-5">
          ...
          <div class="moz-pill bg-pink restaurant-mp-pink">
            <i class="icon mozresticons-ok-circle"></i>
            <?php esc_html_e( 'Allow your customers to access new dinners', 'mozrest' ); ?>
          </div>
      ...
      <div class="col-lg-10">
        <div class="row align-items-center justify-content-between">
          <div class="col-md-5" data-aos="fade-right">
            ...
            <p>
              <a href="" class="btn-link text-green chat-bot"><?php esc_html_e( 'Know more', 'mozrest' ); ?> <i
...
<section class="bg-light-green text-blue mb-5 pb-0 pt-5">
  <div class="container">
    <div class="row justify-content-center">
