        ...
        <div class="container">
          ...
          <div class="blog-presentation-content-text">
            <h2 class="text-black fs30" data-aos="fade-up">
              Discover the latest information on Food & Beverage Digital Marketing
            </h2>
          </div>
        </div>
      </div>
              ...
              <div class="row">
                ...
                <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
                  ...
                  <div class="bg-blue text-white r-4 px-5 pt-4 pb-5">
                    ...
                    <p class="mb-4">
                      We'll find missing or inaccurate data
                    </p>
        ...
        <div class="row align-items-center">
          <div class="col-md-5 order-md-1 order-2" data-aos="fade-right">
            <div class="pt-md-6 ps-md-5 pt-4">
              <img class="img-auto m-auto" style="max-width:255px" src="<?php bloginfo('template_url'); ?>/img/man-1.png" alt="MOZREST" />
            </div>
          </div>
          <div class="col-md-7 order-md-2 order-1">
            <div class="block-size-2 ms-0 pt-md-0 pt-5" data-aos="fade" data-aos-delay="300">
              <h2 class="mb-3">Digital Marketing is complex</h2>
              <p>
